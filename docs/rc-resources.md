...
[Globus](https://learning.rc.virginia.edu/notes/globus-data-transfer/) is the recommended way to move large datasets between your laptop, cloud or lab storage, and HPC-mounted paths (`/home`, `/scratch`, `/project`, `/standard`). Use the managed collection **UVA Standard Security Storage** in the Globus File Manager; for a local machine, install [Globus Connect Personal](https://www.globus.org/globus-connect-personal) first.
...
Controlled-access, regulated, or otherwise highly sensitive data must not be processed on Afton/Rivanna. Use RC's high-security offerings instead ([Ivy virtual machines and Rio HPC](https://rc.virginia.edu/services/compute-and-storage/ivyrio)). **When in doubt, ask the RC team which option fits your use case.**

## Other RC services

Beyond Rivanna/Afton HPC and storage, Research Computing also offers consulting and platform services that many data science projects use alongside the cluster. Browse the full catalog on [RC Services](https://rc.virginia.edu/services). Highlights include:

- [UVA RC GenAI](https://rc.virginia.edu/services/uva-rc-genai): generative AI tools for UVA research
- [Research Application Services](https://rc.virginia.edu/services/research-application-services): supported containerized / microservice application hosting
- [Data Analytics Center](https://rc.virginia.edu/services/data-analytics-center): collaborative analysis support, including AI applications
